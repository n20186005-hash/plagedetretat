...
export function CookiesPage() {
  ...
  const sections = [
    { titleKey: "cookies.section1_title", contentKey: "cookies.section1_content" },
    { titleKey: "cookies.section2_title", contentKey: "cookies.section2_content" },
    { titleKey: "cookies.section3_title", contentKey: "cookies.section3_content" },
    { titleKey: "cookies.section4_title", contentKey: "cookies.section4_content" },
    { titleKey: "cookies.section5_title", contentKey: "cookies.section5_content" },
    { titleKey: "cookies.section6_title", contentKey: "cookies.section6_content" },
  ];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 sm:py-16">
        <div className="mb-8">
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight">{t('cookies.title')}</h1>
          <p className="mt-2 text-sm text-muted-foreground">{t('cookies.last_updated')}</p>
        </div>
