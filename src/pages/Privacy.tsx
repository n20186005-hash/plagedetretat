...
export function PrivacyPage() {
  ...
  const sections = [
    { titleKey: "privacy.section1_title", contentKey: "privacy.section1_content" },
    { titleKey: "privacy.section2_title", contentKey: "privacy.section2_content" },
    { titleKey: "privacy.section3_title", contentKey: "privacy.section3_content" },
    { titleKey: "privacy.section4_title", contentKey: "privacy.section4_content" },
    { titleKey: "privacy.section5_title", contentKey: "privacy.section5_content" },
  ];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 sm:py-16">
        <div className="mb-8">
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight">{t('privacy.title')}</h1>
          <p className="mt-2 text-sm text-muted-foreground">{t('privacy.last_updated')}</p>
        </div>
